...
public class JavaSoundRecorderMS {
...
//	static JSONObject webPages = null; //for bing
    ...
    File wavFile = new File("/Users/karan.verma/Downloads/test1.wav");
    ...
    void finish() {
    	try 
    	{
    		...
    		System.out.println("Bing STT start : "+c);
    		...
    		System.out.println("Bing STT finish : "+System.currentTimeMillis()+ ". Total time "+(System.currentTimeMillis()-c));
    		...
    		//searchQuery = QuickstartSample.speechToText(wavFile.getAbsolutePath());
...
//    	}
    ...
    public static void main(String[] args) {
        ...
        JavaSoundRecorderMS.populateMap();
    	
    	headers=new ArrayList<NameValuePair>();
        final JavaSoundRecorderMS recorder = new JavaSoundRecorderMS();
